...
const STRINGS = {
  en: {
    ...
    streak_help: "Days in a row you have logged something",
    ...
    check_counting: "Check the counting",
    calibrate_why: "If the count looks wrong for how you carry your phone, walk a short measured stretch and the app will correct itself to your gait.",
    calibrate_how: "Put your phone where you normally carry it, walk 20 steps at your usual pace, then tell the app how many you really took.",
    calibrate_start: "Start a calibration walk",
    calibrate_walk_now: "Press start, then walk {n} steps normally.",
    calibrate_counting: "Walk {n} steps, then press Save.",
    calibrate_confirm: "The app counted {n}. How many did you actually take?",
    calibrate_how_many: "Steps you really took",
    calibrate_too_few: "Too few steps to judge. Walk at least 10 and try again.",
    calibrate_need_number: "Enter how many steps you took.",
    calibrate_reset: "Clear the correction",
    calibrated_high: "Your phone counts about {n}% high. Corrected from now on.",
    calibrated_low: "Your phone counts about {n}% low. Corrected from now on.",
    calibrated_exact: "Counting matches your steps — no correction needed.",
    walking_detected: "Walking",
    watching_for_walking: "Watching for a walking rhythm",
    walk_mode: "Walk mode",
    ...
    phone_counter_now: "Phone counter right now",
    phone_counter_waiting: "Waiting for the phone's counter — take a few steps and it will report in.",
    phone_counter_unavailable: "This phone isn't sharing its step counter.",
    no_steps_history: "No steps logged in the last 7 days yet.",
  ...
  mr: {
    ...
    streak_help: "सलग किती दिवस नोंद केली",
    ...
    check_counting: "मोजणी तपासा",
    calibrate_why: "तुम्ही फोन ज्या पद्धतीने ठेवता त्यानुसार आकडा चुकीचा वाटत असेल, तर थोडं मोजून चाला — अ‍ॅप तुमच्या चालीनुसार जुळवून घेईल.",
    calibrate_how: "फोन नेहमीप्रमाणे ठेवा, नेहमीच्या वेगाने २० पावलं चाला, आणि मग खरी पावलं किती होती ते सांगा.",
    calibrate_start: "तपासणीसाठी चाला",
    calibrate_walk_now: "सुरू दाबा, मग नेहमीसारखी {n} पावलं चाला.",
    calibrate_counting: "{n} पावलं चाला, मग जतन करा दाबा.",
    calibrate_confirm: "अ‍ॅपने {n} मोजली. तुम्ही खरंच किती चाललात?",
    calibrate_how_many: "खरी चाललेली पावलं",
    calibrate_too_few: "इतक्या कमी पावलांवरून ठरवता येणार नाही. किमान १० पावलं चाला.",
    calibrate_need_number: "किती पावलं चाललात ते लिहा.",
    calibrate_reset: "दुरुस्ती काढून टाका",
    calibrated_high: "तुमचा फोन सुमारे {n}% जास्त मोजतो. आतापासून दुरुस्त केलं जाईल.",
    calibrated_low: "तुमचा फोन सुमारे {n}% कमी मोजतो. आतापासून दुरुस्त केलं जाईल.",
    calibrated_exact: "मोजणी तुमच्या पावलांशी जुळते — दुरुस्तीची गरज नाही.",
    walking_detected: "चालणं सुरू",
    watching_for_walking: "चालण्याची लय शोधत आहे",
    ...
    phone_counter_now: "फोनचा काउंटर आत्ता",
    phone_counter_waiting: "फोनच्या काउंटरची वाट पाहत आहोत — थोडं चालल्यावर आकडा येईल.",
    phone_counter_unavailable: "हा फोन त्याचा स्टेप काउंटर देत नाही.",
    no_steps_history: "मागील ७ दिवसांत पावलांची नोंद नाही.",
